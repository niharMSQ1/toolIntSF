"""Refresh Linear OAuth access tokens."""
...
from app.integrations.categories.itsm.linear import oauth
from app.integrations.categories.itsm.linear.credentials import resolve_oauth_credentials, resolve_refresh_token
from app.integrations.core.persistence import tool_integration_service as persistence


def refresh_linear_access_tokens(session: Session, row: dict[str, Any], *, force: bool = False) -> tuple[dict[str, Any], bool]:
    """

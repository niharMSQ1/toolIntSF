...
from app.integrations.categories.idp.google_workspace.seed import GOOGLE_WORKSPACE_IAM_SEED_ROWS
...
def seed_google_workspace_evidence_masters(session: Session, tool_id: str) -> int:
    did = get_domain_id_for_tool(session, tool_id)
    count = 0
    for row in GOOGLE_WORKSPACE_IAM_SEED_ROWS:

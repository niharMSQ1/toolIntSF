...
from app.integrations.categories.idp.sailpoint.seed import SAILPOINT_IAM_SEED_ROWS
...
def seed_sailpoint_evidence_masters(session: Session, tool_id: str) -> int:
    did = get_domain_id_for_tool(session, tool_id)
    count = 0
    for row in SAILPOINT_IAM_SEED_ROWS:

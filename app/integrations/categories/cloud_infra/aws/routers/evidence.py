"""Explicit AWS evidence collection endpoint."""
...
router = APIRouter(prefix="/api/v1/evidence", tags=["evidence", "cloud_infra", "aws"])


@router.post("/aws/collect", response_model=CollectEvidenceResponse)

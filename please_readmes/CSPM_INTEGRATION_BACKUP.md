...
**Remaining (planned queue):** Aqua Security, Check Point CloudGuard, Sysdig Secure — same pattern: `please_readmes/0013+`, `sync_dispatch`, `api.py`, Postman.
...
**Global `evidence_masters.code` uniqueness:** CSPM tools use non-overlapping EV bands: Prisma **EV-701+**, Defender **EV-711+**, Orca **EV-721+**, Lacework **EV-731+**.

**Postman:** `postman/ToolIntegrations.postman_collection.json`

**Mount:** `app/integrations/api.py` → `mount_integration_routes`

Last updated: 2026-03-28 — Lacework (`lacework`); Postman + `0012 - lacework.md` + index + backup.
